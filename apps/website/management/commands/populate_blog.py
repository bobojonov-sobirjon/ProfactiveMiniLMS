        ...
        blog_data = [
            {
                ...
                'description': 'Заполните форму, скопируйте ссылку, отправьте ее личным сообщением. Получите 16% с каждой продажи! Это отличная возможность для дополнительного заработка.',
